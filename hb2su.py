...
t.goto(-400, 230)
t.pendown()
t.write('To：宿世鸿  ', font=('方正舒体', 32, 'bold'))
t.color('red')
t.penup()
t.goto(-150, -110)
t.pendown()
t.write('祝 你 生 日 快 乐！', font=('方正舒体', 30, 'bold'))
t.color('red')
t.penup()
t.goto(-300, -160)
t.pendown()
t.write('不 止 生 日，每 天 都 要 开 心 呀！', font=('方正舒体', 30, 'bold'))
t.color('blue')
t.penup()
t.goto(-200, -220)
t.pendown()
t.write('————一个不太值钱但是起码有点心意的生日祝福', font=('方正舒体', 20, 'bold'))
t.color('blue')
t.penup()
t.goto(190, -250)
t.pendown()
t.write('From：李凌炜 2023/4/20', font=('方正舒体', 15, 'bold'))
t.penup()
t.done()
